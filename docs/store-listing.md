...
Build personalized queues that mix your SoundCloud likes and feed, randomized across track production years. Built-in player, no accounts, all local.
...
Built-in player with HLS streaming. No SoundCloud tab needed for playback. Queue and playback position persist across sessions. Shows up in your browser's media controls with title, artist, and play/pause/next/prev.
